...
public class ExcelUtil {
    ...
    public static void exportExcel(String title,Map<String, String> headMap,JSONArray jsonArray,String datePattern,int colWidth, OutputStream out) {
        ...
        workbook.getDocumentSummaryInformation().setCompany("徐州云渊科技公司");
        SummaryInformation si = workbook.getSummaryInformation();
        si.setAuthor("yunyuan");  //填加xls文件作者信息
        si.setApplicationName("导出程序"); //填加xls文件创建程序信息
        si.setLastAuthor("lastauthor"); //填加xls文件最后保存者信息
        si.setComments("yunyuan Technology"); //填加xls文件作者信息
        si.setTitle("yunyuan"); //填加xls文件标题信息
        si.setSubject("yunyuan");//填加文件主题信息
