...
public class Constant {
   ...
   // public static final String BASE_URL = "https://device.api.ct10649.com:8743";
    ...
    public static final String APPID = "JNdgmfWTzyXsJBYJLItjIj6Yt80a";
    public static final String SECRET = "4WhTfUCeLtQB7f7UBO1IloD7gRoa";
    /**
     * 服务器地址和端口号
     */
    //public static final String CALLBACK_BASE_URL = "http://116.62.70.151:8082";
    public static final String CALLBACK_BASE_URL = "https://223.167.110.85:18082";
    ...
    public static final String COMMAND_RSP_CALLBACK_URL = CALLBACK_BASE_URL + "/na/commandRspData";
    ...
    public static String SELFCERTPATH = "/src/main/java/resource/cert/outgoing.CertwithKey.pkcs12";
    public static String TRUSTCAPATH = "/src/main/java/resource/cert/ca.jks";

    public static String STANDUP_SELFCERTPATH = "/resource/outgoing.CertwithKey.pkcs12";
    public static String STANDUP_TRUSTCAPATH = "/resource/ca.jks";
