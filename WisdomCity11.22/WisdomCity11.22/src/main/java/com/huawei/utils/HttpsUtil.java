...
public class HttpsUtil extends DefaultHttpClient {
	...
	public void initSSLConfigForTwoWay() throws Exception {
		...
		dealInitSSLConfigForTwoWay(selfcertpath,trustcapath);
	}

	public void initSSLConfigForTwoWay(String demo_base_Path) throws Exception {
		String selfcertpath = demo_base_Path + Constant.STANDUP_SELFCERTPATH;
		String trustcapath = demo_base_Path + Constant.STANDUP_TRUSTCAPATH;
		dealInitSSLConfigForTwoWay(selfcertpath,trustcapath);
	}

	private void dealInitSSLConfigForTwoWay(String selfcertpath,String trustcapath) throws Exception{
