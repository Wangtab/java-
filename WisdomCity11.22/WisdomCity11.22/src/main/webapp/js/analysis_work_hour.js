    ...
    $(function() {
        ...
        $('.import_btn').unbind('click').click(function(){
            var searchBox =  $('.search_box');
            var url = "exportWorkHourAnalysisDataForList?areaId="+searchBox.find('select[name="areaId"]').val() +
    ...
    function selectAll(){
        ...
        proUntil.request("workHourAnalysisDataForList",paramObj,function(data){
            if("n" == data){
                $('.table_list').hide();
                $('.area_model').hide();
