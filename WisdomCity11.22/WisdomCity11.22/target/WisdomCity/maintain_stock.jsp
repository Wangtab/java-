...
<head>
	...
	<script type="text/javascript" src = "js/maintain_stock.js"></script>
...
<body>
	...
	<form class="table_win" action="javascript:;" method="post" onsubmit="saveData()">
		...
		<div class="form_box">
			<span>当前库存量</span>
			<input type="text" class="stocknum" name="stocknum"  maxlength="8" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
		</div>
		<div class="form_box">
			<span>备注</span>
	...
	<div class="judge_win">
		...
		<h1>确定要删除该条信息吗？</h1>
		<div class="judge_btn">
			<h2 class = "sure_delete_judge_win" url = "Maintain/delStockDataById">确定</h2>
