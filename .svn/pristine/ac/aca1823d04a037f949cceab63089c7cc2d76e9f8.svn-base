...
<head>
	...
	<script type="text/javascript" src = "js/routingInspectionManage.js"></script>
...
<body>
		...
		<div class="table_box">
			<table>
				<tr>
					...
					<th orderby = "roadName" width="6%">巡检路段</th>
	...
	<div class="judge_win">
		...
		<h1>确定要删除该条信息吗？</h1>
		<div class="judge_btn">
			<h2 class = "sure_delete_judge_win" url = "deleteRoutingInspectionManage.do">确定</h2>
