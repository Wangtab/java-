...
<head>
    ...
    <script type="text/javascript" src="js/analysis_energy.js" charset="UTF-8"></script>
...
<div class="work_content_box">
    ...
    <form action="javascript:;" method="post" class="search_box" onsubmit="selectAll()">
        ...
        <div id="del_btn" class="add_btn" >清空输入数据</div>
        <div id="import_btn"  class="import_btn">导出数据</div>
    </form>

    <div class="area_analysis">
        <div class="table_list">
            <div class="analysis_title">能耗列表</div>
            <table>
                <tr>
                    <th sort="name">名称</th>
                    <th sort="power">能耗（kwh）</th>
                </tr>
            </table>
            <div class="page">
