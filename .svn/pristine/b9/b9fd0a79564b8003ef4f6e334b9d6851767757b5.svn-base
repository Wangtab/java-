...
<head>
    ...
    <script type="text/javascript" src = "js/dianbiao_setting.js"></script>
</head>
<body>
<h6></h6>
...
<div class="judge_win">
    ...
    <h1>确定要删除该条信息吗？</h1>
    <div class="judge_btn">
        <h2 class = "sure_delete_judge_win" url ="safe/deleteAmmeterDataById">确定</h2>
