...
<head>
  ...
  <script type="text/javascript" src = "js/concentrator_setting.js"></script>
...
<form action="javascript:;" class="second_form" onsubmit="saveData()">
  ...
  <div class="form_detail_warpper">
    <div class="detail_box">
      <span>集中器地址</span>
      <input type="text" name="concentratoraddr" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')">
    </div>
    <div class="detail_box">
      <span>集中器类型</span>
      <input type="text" name="cKind" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')">
    </div>
    <div class="detail_box">
      <span>集中器名称</span>
      <input type="text" name="concentratorname" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')">
    </div>
    <div class="detail_box">
      <span>集中器描述</span>
      <input type="text" name="concentratordes" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')">
    </div>
    <div class="detail_box">
      <span>所属区域</span>
      <select name="areaid" id="areaId" required="required" oninvalid="setCustomValidity('请选择该条信息')" oninput="setCustomValidity('')"></select>
    </div>
    <div class="detail_box">
      <span>所属道路</span>
      <select name="roadId" id="roadId" required="required" oninvalid="setCustomValidity('请选择该条信息')" oninput="setCustomValidity('')"></select>
    </div>
    <div class="detail_box">
      <span>配电箱编号</span>
      <select name="ibox" required="required" oninvalid="setCustomValidity('请选择该条信息')" oninput="setCustomValidity('')"></select>
    </div>
    <div class="detail_box">
      <span>集中器型号</span>
      <input type="text" name="cModel" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')">
    </div>
    <div class="detail_box">
      <span>厂家名称</span>
      <input type="text" name="factoryName" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')">
    </div>
    <div class="detail_box">
      <span>经度</span>
      <input type="text" name="lo" readonly="readonly" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')" id = "longitude_ipt"/>
    </div>
    <div class="detail_box">
      <span>纬度</span>
      <input type="text" name="la" readonly="readonly" required="required" oninvalid="setCustomValidity('请填写该条信息')" oninput="setCustomValidity('')" id = "latitude_ipt"/>
    </div>
