...
public class SunRiseSet {
    ...
    public static String getSunrise(int year, int month, int date, double glong, double glat) {
        double sunrise;
    ...
    public static String getSunset(int year, int month, int date, double glong, double glat) {
        double sunset;
